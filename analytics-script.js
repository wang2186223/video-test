...
// 主控制表格 ID: 10eGvKzckqlnTrKCkKQomRIcZY28G78K8M5-TyhJyhO8
...
// - 表格命名：adx-zjy-2025-01-15
// - 文件夹：所有每日表格存放在"网站统计数据"文件夹中

// ==================== 配置常量 ====================

const MAIN_SPREADSHEET_ID = '10eGvKzckqlnTrKCkKQomRIcZY28G78K8M5-TyhJyhO8';
const DATA_FOLDER_NAME = '网站统计数据';
const SPREADSHEET_PREFIX = 'adx-zjy-';
